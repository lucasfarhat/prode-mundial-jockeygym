...
// Fases eliminatorias: NO se listan aca. Los 16avos en adelante los crea y
// completa solo el sync (public.sync_mundial) en la base, a medida que la API
// publica los cruces. La app los lee directamente de Supabase (ver Fixture.jsx).
